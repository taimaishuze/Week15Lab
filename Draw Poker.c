...
//  Example poker program from Appendix B of Absolute Beginners's
//  Guide to C, 3rd Edition
//  File AppendixBpoker.c

//* This program plays draw poker.  Users can play as often as they want, betting between 1 and 5 cards and then get to choose which cards to keep,
//  and which cards to replace.  The new hand is then reviewed and the user's payout is set based on the value of the hand.
...
//  This function is called outside the do...while loop because the greeting only needs to be displayed once, while
...
//  Functions to get the user's bet between 1 and 5
...
//  if they want to keep the cards.  If they say no, they get a replacement card.
